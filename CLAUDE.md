...
| `flashcards` | **Orbite** | révision par répétition espacée, système de Leitner à 5 boîtes | découpage complet livré (import en masse, sans outbox ni rappel dédié) — voir `docs/etude-flashcards.md` §9 et §15 |
