...
| `flashcards` | **Orbite** | révision par répétition espacée, système de Leitner à 5 boîtes | découpage complet livré, rendu mobile vérifié, recto/verso en éditeur de texte riche (Tiptap, 8 mises en forme) — voir `docs/etude-flashcards.md` §9, §15, §16, §19-§20 (remplacent §17-§18) |
