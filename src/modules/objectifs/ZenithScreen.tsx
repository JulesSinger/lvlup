 ...
 *
 * Reçu par le hub une fois l'utilisateur authentifié — ce module ne connaît
...
export function ZenithScreen({
  ...
  const onboardingDone = onboardedId === user.id;
  ...
  // Changement d'utilisateur (ou nouvelle session sur ce module) : tout ce
  // qui est à l'écran appartenait à l'utilisateur ou à la session précédente.
  useEffect(() => {
    setEditing(null);
    setPicking(false);
    setSeedActions(null);
